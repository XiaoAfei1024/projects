...
public class RSAUtils {
    ...
    public static String decryptByPrivate(String content, PrivateKey privateKey) {
        ...
        try {
            ...
            return decrypt(content, cipher, splitLength);
        } catch (NoSuchAlgorithmException e) {
            log.error("encrypt()#NoSuchAlgorithmException", e);
        } catch (NoSuchPaddingException e) {
            log.error("encrypt()#NoSuchPaddingException", e);
     ...
     * @return
     */
    private static String decrypt(String content, Cipher cipher, int splitLength) {
        try {
    ...
    public static void main(String[] args) {
        ...
        String encryptData = RSAUtils.encryptByPublic("szwg2018".getBytes(), publicKey);
        System.out.println(encryptData);
        PrivateKey privateKey = RSAUtils.getPrivateKey();
        String decryptData = RSAUtils.decryptByPrivate(encryptData, privateKey);
